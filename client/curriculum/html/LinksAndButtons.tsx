      ...
      >
        ...
        <section>
          ...
          <p>
            ...
            <i>link</i>
            {' '}
            este unul din cele mai uzuale elemente
            folosite pentru construirea paginilor web. Dacă vrem să ne mutam la
            o altă pagină sau la o altă zonă în cadrul aceleiași pagini, atunci
            vom folosi acest element. Modalitatea prin care adăugăm un link
            într-o pagină este prin folosirea atributului
            {' '}
...
<a href="https://frontend.ro/"> Frontend.ro </a>`}
          ...
          <LessonFigure
            withBorder
            src="/images/lessons/links-and-buttons/link-to-a-page.png"
            alt="Cel mai uzual mod de a folosi tag-ul a - URL-uri absolute"
            demo="/demo/html/url-absolut"
          />
          <p>
...
<a href="/pages/about.html">About</a>`}
          ...
          <LessonFigure
            withBorder
            src="/images/lessons/links-and-buttons/relative-url.png"
            alt="URL-uri relative"
            demo="/demo/html/url-relativ"
          />
          <p>
...
<h2 id="Section-further-down">Section further down</h2>
          ...
          <LessonFigure
            withBorder
            src="/images/lessons/links-and-buttons/jump-links.png"
            alt="Link-uri care duc către o secțiune ale
            aceleiași pagini sau așa numitele jump links"
          ...
          <LessonFigure
            isVideo
            withBorder
            src="/videos/links-and-buttons/smooth-scrolling.mp4"
...
<a href="mailto:hello@frontend.ro">
  Trimite email la Frontend.ro
          ...
          <LessonFigure
            withBorder
            src="/images/lessons/links-and-buttons/mailto.png"
...
`}
          ...
          <LessonFigure
            withBorder
            src="/images/lessons/links-and-buttons/tel.png"
...
`}
          ...
          <LessonFigure
            withBorder
            src="/images/lessons/links-and-buttons/download.png"
...
<a href="http://frontend.ro" target="_blank" rel="noopener noreferrer">
  Link-ul se deschide într-un nou tab
          ...
          <LessonFigure
            withBorder
            src="/images/lessons/links-and-buttons/rel.png"
            alt="Atributul rel cu valorile noopener și noreferrer"
            demo="/demo/html/noopener-noreferrer-rel"
          />
          <ul className="with--bullets">
            <li>
              <strong className="formatted">rel="noopener"</strong>
              : blochează
              accesul tabului nou la pagina ce conține link-ul, și astfel ne
              protejează de atacuri ca cel de mai jos:
            </li>
            <li>
...
<a title="Nu ar trebui să fiu aici" href="/">
  Un simplu exemplu
          ...
          <LessonFigure
            withBorder
            src="/images/lessons/links-and-buttons/title-link.png"
            alt="Atributul title ca link"
            demo="/demo/html/atributul-title-ca-link"
          />
          <p>
  ...
  <img src="images/logo.png" alt="Frontend.ro LOGO." />
        ...
        <section>
          ...
          <p>
            ...
            {' '}
            este folosit atunci cînd vrem să facem o acțiune (exemple uzuale de
            acțiuni: selectăm un element sau mergem cu mouse-ul deasupra lui
            (hover) , o pagină web se încarcă (load), dăm click pe un buton sau
            alegem o cheie de la tastatură, facem resize la o fereastră sau o
            închidem, dăm play sau pause la un video, etc.
          </p>
          <p>
...
<form className="login-container">
  ...
  <button type="submit" disabled>Loghează-te</button>
          ...
          <LessonFigure
            isVideo
            withBorder
            src="/videos/links-and-buttons/form_validation_with_disabled_button.mp4"
