<LessonHeading as="h2" id={SCOPE.headings[0].id}>
  {SCOPE.headings[0].title}
</LessonHeading>
...
<section>
  {<LessonHeading as="h2" id={SCOPE.headings[1].id}>
    {SCOPE.headings[1].title}
  </LessonHeading>}
...
<section>
  {
    <LessonHeading as="h2" id={SCOPE.headings[2].id}>
      {SCOPE.headings[2].title}
    </LessonHeading>
  }
...
<section>
  <LessonHeading as="h2" id={SCOPE.headings[3].id}>
    {SCOPE.headings[3].title}
  </LessonHeading>
...
<div className="dots" />
<section>
  <LessonHeading as="h2" id={SCOPE.headings[4].id}>
    {SCOPE.headings[4].title}
  </LessonHeading>
...
<div className="dots" />
<section>
  <LessonHeading as="h2" id={SCOPE.headings[5].id}>
    {SCOPE.headings[5].title}
  </LessonHeading>
...
<section>
  <LessonHeading as="h2" id={SCOPE.headings[6].id}>
    {SCOPE.headings[6].title}
  </LessonHeading>
 ...
 <section>
  <LessonHeading as="h2" id={SCOPE.headings[7].id}>
    {SCOPE.headings[7].title}
  </LessonHeading>
