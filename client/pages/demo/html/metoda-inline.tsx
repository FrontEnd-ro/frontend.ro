  ...
  return(
    <>
      ...
      <>
        ...
        <h1 style={{textAlign: 'center', fontSize: '45px', fontFamily: 'sans-serif', 
          color: 'red', textShadow: '2px 2px 0 #000' }}>Metoda inline</h1>
        <p style={{color: '#000', marginLeft: '50px', fontSize: '25px', fontFamily: 'sans-serif'}}>Stilurile sunt destul de greu de citit si editat.</p>
        <p style={{color: '#fff', marginLeft: '50px', fontSize: '27px', fontFamily: 'sans-serif'}}>De aceea recomandăm evitarea <span style={{ fontSize: '30px', fontWeight: 'bold', color: '#000'}}> acestei metode </span>.</p>
        </div> 
          </DemoPreview>
          <Highlight
            className="my-5"
